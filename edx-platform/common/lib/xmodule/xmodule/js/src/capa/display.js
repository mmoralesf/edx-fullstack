...
(function() {
  ...
  this.Problem = (function() {
    ...
    Problem.prototype.bind = function() {
      ...
      this.$('div.action button.hint-button').click(this.hint_button);
      this.$('div.action button.reset').click(this.reset);
      this.$('div.action button.show').click(this.show);
      this.$('div.action button.save').click(this.save);
    ...
    */
    ...
    Problem.prototype.hint_button = function() {
      ...
      return $.postWithPrefix("" + this.url + "/hint_button", {
        ...
        _this.$('.problem-hint').html(response.contents);
        _this.$('.problem-hint').attr('hint_index', response.hint_index);
